...
public class AutoSS {
    ...
    public static void register() {
        ...
        HudElementRegistry.addLast(Identifier.fromNamespaceAndPath("blackaddons", "autoss_overlay"), AutoSS::onRenderHud);
    ...
    private static void onRenderHud(GuiGraphicsExtractor graphics, net.minecraft.client.DeltaTracker tracker) {
        ...
        for (String line : debugInfo) {
            graphics.text(client.font, line, overlayX, y, COLOR_TEXT_WHITE);
            y += 10;
        }
        graphics.text(client.font, ChatFormatting.YELLOW + "Solution:", overlayX, y, COLOR_TEXT_WHITE);
        y += 10;
        for (int i = 0; i < solution.size(); i++) {
            graphics.text(client.font, (i + 1) + ". " + solution.get(i).toShortString(), overlayX + 10, y, COLOR_TEXT_WHITE);
            y += 10;
        }
